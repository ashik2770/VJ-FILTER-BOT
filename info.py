...
API_ID = int(environ.get('API_ID', '22371486'))
API_HASH = environ.get('API_HASH', '32d415231ca7f101277ba348ba2ef039')
BOT_TOKEN = environ.get('BOT_TOKEN', "8087088845:AAEc2O355OM_ulpgo8CxwR5deY3Z8PNZobg")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002617488562'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002622769074').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ajashik978:ashik27445@messaging.sqtqn.mongodb.net/?retryWrites=true&w=majority&appName=Messaging")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Messaging")
